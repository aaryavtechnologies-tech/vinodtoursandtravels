...
DELHI_PHONE='+91 90455 11378'
ADDRESS='Near UGB Bank, East, Jhandichour, Kotdwara, Uttarakhand 246149, India'
DELHI_ADDRESS='Store No. 8, Sector 2, R.K. Puram, New Delhi 110022, India'
...
# The owner supplied a replacement customer photograph for this tour card.
for tour in tours:
    if tour['title'] == 'Golden Triangle Tour – 6 Days':
        tour['image'] = 'assets/traveller-photos/golden-triangle-6-days.jpeg'
for package in source.select('a.package-anchor'):
    if package.select_one('.pkg-title').get_text(strip=True) == 'Golden Triangle Tour – 6 Days':
        package.img['src'] = 'assets/traveller-photos/golden-triangle-6-days.jpeg'
...
top.clear()
top.append(BeautifulSoup(f'<div class="topline"><a href="tel:+918076069722"><i class="fa-solid fa-phone-volume"></i> Kotdwar: <strong>{PHONE}</strong></a><a href="tel:+919045511378"><i class="fa-solid fa-phone-volume"></i> Delhi: <strong>{DELHI_PHONE}</strong></a><a href="{MAP}" target="_blank" rel="noopener"><i class="fa-solid fa-location-dot"></i> Kotdwar</a><a href="{DELHI_MAP}" target="_blank" rel="noopener"><i class="fa-solid fa-location-dot"></i> Delhi</a></div>','html.parser'))
...
footer=f'''<footer class="site-footer"><div class="footer-grid"><div><h3>OUR OFFICES</h3><p><strong>Kotdwar Office</strong><br>{ADDRESS}</p><a href="tel:+918076069722"><i class="fa-solid fa-phone"></i> {PHONE}</a><br><a href="{WA}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Kotdwar</a><br><a href="{MAP}" target="_blank" rel="noopener">Kotdwar directions ↗</a><p><strong>Delhi Office</strong><br>{DELHI_ADDRESS}</p><a href="tel:+919045511378"><i class="fa-solid fa-phone"></i> {DELHI_PHONE}</a><br><a href="{DELHI_WA}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Delhi</a><br><a href="{DELHI_MAP}" target="_blank" rel="noopener">Delhi directions ↗</a><p><a href="mailto:{EMAIL}"><i class="fa-regular fa-envelope"></i> {EMAIL}</a></p></div><div><h3>TOUR PACKAGES</h3><a href="agra-tours.html">Agra Tours</a><a href="delhi-tours.html">Delhi Tours</a><a href="rajasthan-tours.html">Rajasthan Tours</a><a href="golden-triangle-tours.html">Golden Triangle</a><a href="golden-triangle-varanasi.html">Golden Triangle & Varanasi</a></div><div><h3>EXPLORE & PLAN</h3><a href="about.html">About us</a><a href="blog.html">Travel blog</a><a href="contact.html">Contact us</a><a href="faq.html">Frequently asked questions</a><a href="privacy.html">Privacy</a><a href="booking-information.html">Booking information</a></div><div><h3>PLAN YOUR NEXT JOURNEY</h3><p>Share your destination, pickup point and travel dates. Let’s start planning your trip.</p><a class="button navy" href="{WA}?text=Hello%20Vinod%20Tour%20and%20Travels%2C%20I%20would%20like%20a%20trip%20quote." target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Kotdwar</a><a class="button navy" href="{DELHI_WA}?text=Hello%20Vinod%20Tour%20and%20Travels%2C%20I%20would%20like%20a%20trip%20quote." target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Delhi</a></div></div><div class="copyright">© 2026 {BRAND}. All rights reserved.</div></footer><a class="whatsapp-float" href="{WA}?text=Hello%20Vinod%20Tour%20and%20Travels%2C%20I%20would%20like%20to%20plan%20a%20trip." target="_blank" rel="noopener" aria-label="Chat with Vinod Tour and Travels on WhatsApp"><i class="fa-brands fa-whatsapp"></i><span>WhatsApp us</span></a>'''
...
save('about','About Us',banner('About Vinod Tour and Travels')+f'<section class="page-content"><div class="two-column"><div><p class="f-family-cursive s-c curs-heading">Explore, enjoy, experience</p><h2 class="heading">Your Travel Contact in Kotdwara</h2><p class="lead-text">{en[90]}</p><a class="button" href="plan-my-trip.html">Plan your trip →</a></div><img class="content-photo" src="{about_img}" alt="Travel experiences across India"></div>{features_html}</section>')

contact=f'''<div><p class="f-family-cursive s-c curs-heading">Let’s talk travel</p><h2 class="heading">Get in Touch</h2><p>For taxi availability, route planning or a trip quote, contact Vinod Tour and Travels directly.</p><div class="contact-card"><h3><i class="fa-solid fa-location-dot"></i>Kotdwar Office</h3><p>{ADDRESS}</p><a href="tel:+918076069722">Call {PHONE}</a><br><a href="{WA}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Kotdwar →</a><br><a href="{MAP}" target="_blank" rel="noopener">Open Kotdwar location in Google Maps ↗</a></div><div class="contact-card"><h3><i class="fa-solid fa-location-dot"></i>Delhi Office</h3><p>{DELHI_ADDRESS}</p><a href="tel:+919045511378">Call {DELHI_PHONE}</a><br><a href="{DELHI_WA}" target="_blank" rel="noopener"><i class="fa-brands fa-whatsapp"></i> WhatsApp Delhi →</a><br><a href="{DELHI_MAP}" target="_blank" rel="noopener">Open Delhi location in Google Maps ↗</a></div><div class="contact-card"><h3><i class="fa-regular fa-envelope"></i>Email</h3><a href="mailto:{EMAIL}">{EMAIL}</a></div></div>'''
